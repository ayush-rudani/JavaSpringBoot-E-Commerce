                            ...
                            <div class="checkbox-form">
                                ...
                                <div class="different-address">
                                    <div class="ship-different-title">
                                        <h3>
                                        <label>Default Shipping Address is set to your account's available address...</label>
                                        </h3>
                                    </div>
                                </div>
                                ...
                                <div class="different-address">
                                    <div class="ship-different-title">
                                        <h3>
                                            ...
                                            <input id="ship-box" type="checkwbox" name="ship-box" value="1">
                                        </h3>
                                    </div>
                                    <div id="ship-box-info" class="row">
                                        <div class="col-md-12">
                                            <div class="checkout-form-list">
                                                ...
                                                <textarea placeholder="Shipping address goes here..." class="form-control" name="address" id="address"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table">
                                    ...
                                    <c:forEach var="i" items="${checkOutList}">
                                        <tr class="cart_item">
                                            ...
                                            <td class="cart-product-total"><span class="amount">$ ${i.product.price}</span></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                    <tfoot>
                                        <tr class="order-total">
                                            <th>Order Total</th>
                                            <td><strong><span class="amount">$ ${checkOutCost}</span></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
