                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="cart-product-name">Category <button class="border-0 bg-transparent"><i class="fa fa-sort"></i></button></th>
                                                <th class="cart-product-name">Description <button class="border-0 bg-transparent"><i class="fa fa-sort"></i></button></th>
                                                <th class="li-product-price">Price <button class="border-0 bg-transparent"><i class="fa fa-sort"></i></button></th>
                                                <th class="li-product-stock-status">Purchase Date&Time <button class="border-0 bg-transparent text-black"><i class="fa fa-sort"></i></button></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="i" items="${purchases}">
                                            <tr>
                                                ...
                                                <td class="li-product-price"><span class="amount">$ ${i.price }</span></td>
                                                 <td class="product-subtotal"><span class="amount">${i.date }</span><br><span class="amount">${i.time }</span></td>
                                            </tr>
                                          </c:forEach>
                                        </tbody>
                                    </table>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="coupon-all">
                                            <div class="coupon">
                                                <input id="coupon_code" class="input-text font-weight-bold" name="coupon_code" value="" placeholder="${purchaseCount}" type="text" disabled>
                                                <input class="button" name="apply_coupon" value="Purchases" type="button">
                                            </div>
                                            <div class="coupon2">
                                                <a href="index.html"><input class="button" name="apply_coupon" value="Home" type="button"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
