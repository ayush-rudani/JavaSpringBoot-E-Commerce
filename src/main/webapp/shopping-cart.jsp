                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <c:forEach var="i" items="${cartList}">
                                            	<tr>
                                                	<td class="li-product-remove"><a href="/cart/remove/${i.id}"><i class="fa fa-times"></i></a></td>
                                                	...
                                                	<br>
                                                	<div class="li-product-name"> ${i.product.description}</div>
                                                	</td>
                                                	<td class="product-subtotal"><span class="amount">$ ${i.product.price}</span></td>
                                            	</tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
